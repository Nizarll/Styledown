def warning_icon(color: str = "red-500") -> str:
    return f'''
    <svg class="{color}" width="32px" height="38px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
